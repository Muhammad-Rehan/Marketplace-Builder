  ...
  return (
    ...
    <div className="w-full ">
      ...
      <div className="bg-[#F6F5FF] py-8">
        <div className="max-w-[1200px] mx-auto px-12">
          ...
          <p className={`text-sm text-black ${lato.className}`}>
            ...
            <span className="text-[#FB2E86]">Signup</span>
          </p>
        </div>
      </div>
      ...
      <div className=" mt-16 mb-16 p-8 rounded-md shadow-md w-[40%] mx-auto bg-white ">
            <h2 className="text-center text-2xl font-bold text-[#151875] mb-4">Sign Up</h2>
            ...
            <form>
              <div className="mb-4">
                <label htmlFor="fname" className="block text-sm font-medium text-gray-600 mb-2">
                  First Name
                </label>
                <input
                  id="fname"
              ...
              <div className="mb-4">
                <label htmlFor="lname" className="block text-sm font-medium text-gray-600 mb-2">
                  Last Name
                </label>
                <input
                  id="lname"
