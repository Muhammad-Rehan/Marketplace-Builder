    ...
    <div className="w-full bg-gray-50">
      ...
      <div className="bg-[#F6F5FF] py-8">
        <div className="max-w-[1200px] mx-auto px-12">
          <h1 className={`text-3xl font-bold text-[#101750] mb-2 ${josefinSans.className}`}>Contact Us</h1>
      ...
      <div className="max-w-[1100px] mx-auto  py-12 flex flex-wrap gap-36">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-6  w-[530px] h-[155px] ">
            <div className="flex gap-16">
            <div className="flex items-center gap-4">
              <span className="w-11 h-11 rounded-full bg-[#5726DF]"></span>
            ...
            <div className="flex items-center gap-4">
              <span className="w-11 h-11 rounded-full bg-[#FB2E86]"></span>
              <div className="text-gray-600">
                <p>Support Forum</p>
                <p>For over 24hr</p>
              </div>
            ...
            <div className="flex gap-16">
            <div className="flex items-center gap-4">
              <span className="w-11 h-11 rounded-full bg-[#FFB265]"></span>
              <div className="text-gray-600">
            ...
            <div className="flex items-center gap-4">
              <span className="w-11 h-11 rounded-full bg-[#1BE982]"></span>
              <div className="text-gray-600">
